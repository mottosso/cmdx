...
class Node:
    ...
    def __init__(self, mobject, exists: bool = ...) -> None: ...
    ...
    @storable.setter
    def storable(self, value) -> None: ...
    def findPlug(self, name, cached: bool = ..., safe: bool = ...): ...
    def update(self, attrs) -> None: ...
    def clear(self) -> None: ...
    def name(self, namespace: bool = ...): ...
    def namespace(self): ...
    def path(self): ...
    shortestPath: Incomplete
    def pop(self, key) -> None: ...
    def dump(self, ignore_error: bool = ..., preserve_order: bool = ...): ...
    def dumps(self, indent: int = ..., sort_keys: bool = ..., preserve_order: bool = ...): ...
    def index(self, plug): ...
    def type(self): ...
    def addAttr(self, attr) -> None: ...
    def hasAttr(self, attr): ...
    def deleteAttr(self, attr) -> None: ...
    def connections(self, type: Incomplete | None = ..., unit: Incomplete | None = ..., plugs: bool = ..., source: bool = ..., destination: bool = ..., connections: bool = ...) -> Generator[Incomplete, None, None]: ...
    def connection(self, type: Incomplete | None = ..., unit: Incomplete | None = ..., plug: bool = ..., source: bool = ..., destination: bool = ..., connection: bool = ...): ...
    def inputs(self, type: Incomplete | None = ..., unit: Incomplete | None = ..., plugs: bool = ..., connections: bool = ...): ...
    def input(self, type: Incomplete | None = ..., unit: Incomplete | None = ..., plug: Incomplete | None = ..., connection: bool = ...): ...
    def outputs(self, type: Incomplete | None = ..., plugs: bool = ..., unit: Incomplete | None = ..., connections: bool = ...): ...
    def output(self, type: Incomplete | None = ..., plug: bool = ..., unit: Incomplete | None = ..., connection: bool = ...): ...
    def rename(self, name) -> None: ...
    is_alive: Incomplete
    hex_str: Incomplete
    hash_code: Incomplete
    type_id: Incomplete
    type_name: Incomplete
    is_a: Incomplete
    is_locked: Incomplete
    is_referenced: Incomplete
    find_plug: Incomplete
    add_attr: Incomplete
    has_attr: Incomplete
...
class AnimCurve(Node):
    ...
    def key(self, time, value, tangents=...) -> None: ...
    def keys(self, times, values, tangents: Incomplete | None = ..., change: Incomplete | None = ...): ...
...
class Plug:
    ...
    def animate(self, values, tangents: Incomplete | None = ...) -> None: ...
    def write(self, value): ...
    def connect(self, other, force: bool = ...) -> None: ...
    def disconnect(self, other: Incomplete | None = ..., source: bool = ..., destination: bool = ...) -> None: ...
    def connections(self, type: Incomplete | None = ..., source: bool = ..., destination: bool = ..., plugs: bool = ..., unit: Incomplete | None = ...) -> Generator[Incomplete, None, Incomplete]: ...
...
class TransformationMatrix(om.MTransformationMatrix):
    ...
    def setRotatePivotTranslation(self, pivot, space=...): ...
    def setScalePivot(self, pivot, space=..., balance: bool = ...): ...
    def setScalePivotTranslation(self, pivot, space=...): ...
...
def find(path, default: Incomplete | None = ...): ...
...
def curve(parent, points, degree: int = ..., form=..., mod: Incomplete | None = ...): ...
